...
// import 'package:todo_ash//add_todo_cubit.dart';
//
//
//
//
...
//             appCubit.get(context).updateDatabase(id: task['id'], AddTodoState: 'done');
//           }, icon: Icon(Icons.done,color: PressedIconColor,),),
//
//           IconButton(onPressed: (){
//             PressedIconColor=Colors.green;
//             appCubit.get(context).updateDatabase(id: task['id'], AddTodoState: 'archived');
